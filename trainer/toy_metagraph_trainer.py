...
class ToyMetaGraphTrainer(BaseTrainer):
    """
    Trainer class
    ...
    def __init__(self, model, loss, metrics, resume, config,
        ...
        super(ToyMetaGraphTrainer, self).__init__(model, loss, metrics, resume, config, train_logger)
        self.config = config
    ...
    def _train_iteration(self, iteration):
        ...
        output,_ = self.model((features,adj._indices(),None,None))
        #print(output[:,0])
        output=output[:num]
